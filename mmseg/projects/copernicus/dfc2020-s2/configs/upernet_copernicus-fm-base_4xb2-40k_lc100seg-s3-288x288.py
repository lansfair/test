...
dataset_type = 'LC100SegS3Dataset'
data_root = 'data/copernicusbench/lc100_s3'
crop_size = (288, 288)
ignore_index = 255
...
train_pipeline = [
    ...
    dict(
        ...
        label_mapping=lc100_label_mapping,
        default_value=0),
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file='static_fnames-train.csv',
        ignore_index=ignore_index,
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_prefix=dict(img_path='s3_olci', seg_map_path='lc100'),
        ann_file='static_fnames-val.csv',
        ignore_index=ignore_index,
        reduce_zero_label=False,
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_prefix=dict(img_path='s3_olci', seg_map_path='lc100'),
        ann_file='static_fnames-test.csv',
        ignore_index=ignore_index,
        reduce_zero_label=False,
        pipeline=test_pipeline,
    ))
