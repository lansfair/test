...
s2_band_wavelengths = [443,490,560,665,705,740,783,842,865,945,1610,2190]
s2_band_bandwidths = [20, 65, 35, 30, 15, 15, 20, 115, 20, 20, 90, 180]
s2_band_stats = dict(
    mean=[
        715.75, 790.08, 989.12, 907.87, 1255.85, 1981.60, 2243.83, 2318.84, 2376.60, 2368.32, 1625.88, 1063.44
    ],
    std=[664.54, 684.60, 672.75, 727.27, 686.61, 1031.59, 1210.08, 1276.39, 1332.25, 1390.04, 948.73, 743.08],
)
...
train_pipeline = [
    dict(type='Load12senImageFromFile'),
