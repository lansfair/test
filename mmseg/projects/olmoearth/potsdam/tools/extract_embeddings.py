...
import sys
PYTHONPATH='/mnt/ht2-nas2/EO_test/zhc/mmsegmentation'
sys.path.append('/mnt/ht2-nas2/EO_test/zhc/mmsegmentation')
...
SCRIPT_DEFAULTS = {
    ...
    # ),
    "config": (
        "projects/olmoearth/configs/potsdam/"
        "olmoearth-base_lp_4xb4-80k_potsdam-rgb-p4-512x512_freeze.py"
    ),
    "output_root": "output/olmoearth_embeddings/potsdam",
