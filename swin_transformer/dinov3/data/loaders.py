...
from .datasets import ADE20K, CocoCaptions, FlatJPGDataset, ImageNet, ImageNet22k, NYU, FlatJPGTxt
...
def _parse_dataset_str(dataset_str: str):
    ...
    for token in tokens[1:]:
        ...
        assert key in ("root", "extra", "split", "seed", "train_ratio", "image_txt_dir", "target_pkl")
    ...
    elif name == "FlatJPGTxt":  # modified by zhoujiwen
        class_ = FlatJPGTxt
    else:
