...
# log_path = "/mnt/htzzb2/00-model/00-wrs/dinov3_distill/training_logs/training_metrics.json"
log_path = "/mnt/htzzb2/00-model/00-wrs/dinov3_distill/training_logs/swin_base_vitl16_ssl_feature_distill_GE+IN22k+ZJSlice_6nodes/training_metrics.json"
