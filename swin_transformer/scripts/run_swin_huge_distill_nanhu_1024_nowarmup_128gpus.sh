...
torchrun --nnodes=$WORLD_SIZE \
  ...
  --config-file dinov3/configs/train/swin_huge_feature_distill_nanhu_128gpus.yaml \
  --output-dir /mnt/si000523ygkv/00-model/dinov3-distill-outputs/swin_base_vitl16_ssl_feature_distill_GE+IN22k+ZJSlice1024_16nodes_nowarmup_lowlr \
