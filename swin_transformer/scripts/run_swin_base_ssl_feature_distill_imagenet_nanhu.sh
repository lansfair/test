...
torchrun --nnodes=$WORLD_SIZE \
  ...
  --config-file dinov3/configs/train/swin_base_feature_distill_vitl16_flatjpgtxt_nanhu.yaml \
  --output-dir /mnt/si000523ygkv/00-model/dinov3-distill-outputs/swin_base_vitl16_ssl_feature_distill_rs+imagenet_6nodes "$@"
