...
EMBED_OUTPUT_DIR="${MM_ARCHIVE_EMBED_HOME}/${CONFIG_NAME}"
mkdir -p "$EMBED_OUTPUT_DIR"

$PYINTERPRETER "$SRCDIR/tools/extract_embeddings.py" "$SRCDIR/configs/$CONFIG_NAME.py" --output-root "$EMBED_OUTPUT_DIR"