#! /usr/bin/bash
#
# Multi-GPU distributed testing script for UniverSat PASTIS-R project.
...
# Number of GPUs / processes. Default: all available GPUs.
...
echo "========================================"
echo "Multi-GPU Testing Launch (PASTIS)"
