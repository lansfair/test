mm_archive_home = "/mnt/htzzb2/EO_test/00-zhumx/Working/Codes/openmmlab/openmmlab_archive"
data_root = "/mnt/htzzb2/EO_test/datasets/SARDet-100k"
...
custom_imports = dict(
    imports=["projects.universat.sardet100kembed.universat"],
