...
embedding_root = f'{mm_archive_home}/embed/m-cashew-plant/self-olmoearth-base-10m-bak_1xb8-50e_m-cashew-plant-s2-linear'
...
optim_wrapper = dict(type="OptimWrapper", optimizer=dict(type="AdamW", lr=5e-2, weight_decay=0.0))
